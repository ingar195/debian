...
## Description
This is the installer we use to prepare deian after the initial installation.
This is the "v2" for https://github.com/ingar195/arch, since i have moved over to debial as my promary os for laptos

## Installation
Here is the basic installation guide:
1. Install debian with the displaymanager you want
2. Install, then reboot without chroot
3. Navigate to where you want to store the script
4. Clone the repository: `git clone https://github.com/ingar195/debian.git`
...
These are stored in a GitHub repo like [this](https://github.com/ingar195/dotfiles.git).
